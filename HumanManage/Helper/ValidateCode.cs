...
namespace HumanManage.Helpers
{
    ...
    public class ValidateCode
    {
        ...
        public byte[] CreateValidateGraphic(string validateCode)
        {
            ...
            try
            {
                ...
                LinearGradientBrush brush = new LinearGradientBrush(new Rectangle(0, 0, image.Width, image.Height),
                 Color.Orange, Color.DarkRed, 1.2f, true);
        ...
        public string CreateCode(int length)
        {
            ...
            for (int i = 0; i < length; i++)
            {
                string a = "012345678998765432100918273645908172635401234567899876543210091827364590817263540123456789987654321009182736459081726354012345678998765432100918273645908172635401234567899876543210091827364590817263540123456789987654321009182736459081726354";
